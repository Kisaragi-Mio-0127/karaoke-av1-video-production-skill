...
bars, while `spectrum-line` renders 40 equally spaced total points joined by
...
through the centre. All spectrum styles create no vinyl.
...
keeps the ASS karaoke, Japanese ruby, singer colours, and cues while removing
