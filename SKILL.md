...
- Make the default primary delivery MP4 with AAC-LC at a configured target of 320 kb/s. Keep `--output` and ordinary playback/package references pointed at this compatibility MP4.
