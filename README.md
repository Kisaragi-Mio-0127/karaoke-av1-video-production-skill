...
The `main` branch targets StrangeUtaGame 1.6.8 with SUG format 0.3.0. Exact
integrations for earlier application releases remain on `sug-1.6.2`,
`sug-1.5.0`, and `sug-1.4.5`.
