    ...
    *,
    ...
    if visual_style == "spectrum-line":
        spectrum_scene = (
            ...
            "showfreqs=s=1040x220:r=30:mode=bar:ascale=log:fscale=log:"
            ...
            "drawbox=x=0:y=216:w=1040:h=4:color=black:t=fill,"
            "lut=y='if(lte(val\\,16)\\,0\\,val*0.34)'[fillmask];"
            "[lineaudio]aformat=channel_layouts=mono,"
            "showfreqs=s=1040x220:r=30:mode=line:ascale=log:fscale=log:"
            f"win_size=4096:overlap=0.80:averaging=4:colors=0x{color},"
            "format=rgba,"
            "colorkey=0x000000:0.06:0.08,alphaextract,"
            "drawbox=x=0:y=216:w=1040:h=4:color=black:t=fill,"
